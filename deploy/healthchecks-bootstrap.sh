...
JOBS = [
    ('expired-carts', 'Sylius — porzucone koszyki', '15 3 * * *', 120),
    ('db-backup', 'Kopia bazy MySQL', '0 3 * * *', 60),
    ('unpaid-orders', 'Sylius — nieopłacone zamówienia', '30 3 * * *', 120),
]
...
for slug, name, schedule, grace_minutes in JOBS:
